...
public class UniversityNetworkView extends BorderPane implements UniversityNetworkUI {
    ...
    private Label lblIsolatedCount;
    ...
    public void update(Observable subject, Object arg) {
        if(subject == model) {
            ...
            int isolatedCount = model.getIsolated().size();

            lblPeopleCount.setText(""+ model.getPeople().size());
            lblMostPopular.setText("" + model.getMostPopular());
            lblIsolatedCount.setText(isolatedCount > 0 ? String.format("%d", isolatedCount) : "No isolated people");
        }
    }
    ...
    private VBox createSidePanel() {
        ...
        personPane.add(btRemovePerson, 2, 4);
        ...
        lblMostPopular = new Label("No most popular");
        lblPeopleCount = new Label("0");
        lblIsolatedCount = new Label("No isolated people");
        VBox statsPane = new VBox(labelCount, lblPeopleCount, labelPopular, lblMostPopular, labelIsolated, lblIsolatedCount);
